...
class Session
{
    ...
    {
        if (!isset($_SESSION['flashed_data'])) {  //if varaible doesnt exist , creates empty array with key
            $_SESSION['flashed_data'] = []; 
        }

        $_SESSION['flashed_data'][$key] = $value;  //saves passing value into created emty array and gives a $key
    }
